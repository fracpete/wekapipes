...
ENV_WP_CLASS_LISTERS = "WP_CLASS_LISTERS"

# environment variable with comma-separated list of class listers to exclude
ENV_WP_CLASS_LISTERS_EXCL = "WP_CLASS_LISTERS_EXCL"

# the default class listers to inspect (for development)
# can be overridden with WP_CLASS_LISTERS environment variable
DEFAULT_WP_CLASS_LISTERS = [
    "wp.class_lister",
    "kasperl.class_lister",
]

# environment variable with comma-separated list of class listers to provided ignored classes
ENV_WP_CLASS_LISTERS_IGNORED = "WP_CLASS_LISTERS_IGNORED"

# environment variable for managing the class cache: on|off|reset
ENV_WP_CLASS_CACHE = "WP_CLASS_CACHE"

# the default class listers that provide ignored classes
# can be overridden with WP_CLASS_LISTERS_IGNORED environment variable
DEFAULT_WP_CLASS_LISTERS_IGNORED = [
    "wp.class_lister_ignored",
]

REGISTRY = ClassListerRegistry(default_class_listers=DEFAULT_WP_CLASS_LISTERS,
                               env_class_listers=ENV_WP_CLASS_LISTERS,
                               env_excluded_class_listers=ENV_WP_CLASS_LISTERS_EXCL,
                               ignored_class_listers=DEFAULT_WP_CLASS_LISTERS_IGNORED,
                               env_ignored_class_listers=ENV_WP_CLASS_LISTERS_IGNORED,
                               app_name="wekapipes",
                               class_cache_env=ENV_WP_CLASS_CACHE)

IMG_REGISTRY = "wp-registry"
