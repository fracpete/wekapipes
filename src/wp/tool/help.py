...
from wp.help import generate_plugin_usage, HELP_FORMATS, HELP_FORMAT_TEXT, HELP_FORMAT_MARKDOWN
from wp.registry import register_plugins, available_pipeline_plugins, REGISTRY
from wp.registry import available_readers, available_filters, available_writers, available_generators
...
def main(args=None):
    ...
    :type args: list
    """
    init_logging(env_var=ENV_WP_LOGLEVEL)
